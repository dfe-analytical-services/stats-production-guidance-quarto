...
- We also have a number of helpful sections on using git in practice at the end of our [RAP page](../RAP/rap.html#Build_capability_within_the_team){target="_blank" rel="noopener noreferrer"}.
